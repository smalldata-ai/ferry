...
class ResourceConfig(BaseModel):
    ...
    primary_key: str = Field(default="_id")
    ...
    file_pattern: Optional[str] = Field(None, description="Glob pattern to match specific files in the source (e.g., '*.csv')")
    merge_key: Optional[str] = Field(None, description="Primary key column used for merging records during upserts")
    columns: Optional[List[str]] = Field(None, description="List of columns for the resource")
    ...
    def get_destination_table_name(self) -> str:
        return self.destination_table_name or self.source_table_name
